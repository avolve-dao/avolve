  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Real-time analytics and insights for your journey
        </CardDescription>
      </CardHeader>
      <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <Progress value={journeyAnalytics?.[0]?.journey_completion_rate * 100 || 0} className="mt-2" />
                    </CardContent>
                  </Card>
                </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-3 gap-4">
                      <div className="flex flex-col items-center">
                        ...
                        <Badge className="mt-2" variant={tesla369Streak?.days_breakdown?.sunday > 0 ? "default" : "outline"}>
                          3
                        </Badge>
                      </div>
                      <div className="flex flex-col items-center">
                        ...
                        <Badge className="mt-2" variant={tesla369Streak?.days_breakdown?.wednesday > 0 ? "default" : "outline"}>
                          6
                        </Badge>
                      </div>
                      <div className="flex flex-col items-center">
                        ...
                        <Badge className="mt-2" variant={tesla369Streak?.days_breakdown?.saturday > 0 ? "default" : "outline"}>
                          9
                        </Badge>
                      </div>
                    </div>
                  ...
                  <CardFooter>
                    <div className="text-sm text-muted-foreground">
                      Last Tesla day: {tesla369Streak?.last_tesla_day ? format(new Date(tesla369Streak.last_tesla_day), 'PPP') : 'None'}
                    </div>
                  </CardFooter>
                </Card>
              </>
      ...
      <CardFooter className="text-sm text-muted-foreground">
        Last updated: {journeyAnalytics?.[0]?.last_refreshed ? format(new Date(journeyAnalytics[0].last_refreshed), 'PPP p') : 'Never'}
      </CardFooter>
    </Card>
  )
}
