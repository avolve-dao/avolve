        ...
        <Card>
          <CardHeader className="flex flex-row items-center gap-4 pb-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Post an update to your Superachiever journey</p>
            </div>
          </CardHeader>
          <CardContent>
            <Textarea
              ...
              <CardHeader className="pb-2">
                <div className="flex justify-between items-start">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold">{post.profiles?.full_name || "Anonymous User"}</h3>
