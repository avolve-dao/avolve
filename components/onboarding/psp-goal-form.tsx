...
export function PSPGoalForm({ onComplete }: PSPGoalFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Goal created!",
        description: "Your Personal Success Puzzle goal has been created. You've earned your first tokens!",
      })
  ...
  return (
    <Card className="w-full max-w-3xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Define one key goal for your Personal Success Puzzle. You'll be able to track progress and earn tokens for check-ins.
        </CardDescription>
      </CardHeader>
