          ...
          <>
            {tokenBalances.map(token => (
              <Card
                ...
                className="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-950/20 dark:to-yellow-950/20 border-amber-200 dark:border-amber-800"
              >
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg font-medium text-amber-800 dark:text-amber-300">
                    {token.token_symbol === 'SAP'
                      ? 'Superachiever Progress'
                      : 'Personal Success Progress'}
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            >
              {checkingIn ? (
                ...
                <span className="flex items-center">
                  ...
                  {formatDistanceToNow(
                    new Date(new Date(lastCheckIn!).getTime() + 6 * 24 * 60 * 60 * 1000)
                  )}
                </span>
              )}
            </Button>
