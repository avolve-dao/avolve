...
export default function MagicLinkEmail({ confirmationUrl, email }: MagicLinkEmailProps) {
  return (
    <Html lang="en">
      <Section style={{ backgroundColor: '#f4f4f5', padding: '20px' }}>
        <Container style={{ maxWidth: 600, margin: '0 auto', backgroundColor: '#fff', borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
          <Section style={{ backgroundColor: '#18181b', padding: '30px 0', textAlign: 'center' }}>
            <Text as="h1" style={{ color: '#fff', margin: 0, fontSize: 24, fontWeight: 600 }}>Magic Link</Text>
          </Section>
          <Section style={{ padding: '35px 30px', color: '#27272a' }}>
            <Text>Hi there,</Text>
            <Text>We've created a magic link for you. Click the button below to securely log in to your account:</Text>
            <div style={{ textAlign: 'center' }}>
              <Button href={confirmationUrl} style={{ backgroundColor: '#18181b', color: '#fff', padding: '12px 30px', borderRadius: 6, fontWeight: 500, fontSize: 16, margin: '20px 0', textAlign: 'center', border: '1px solid transparent', textDecoration: 'none', display: 'inline-block' }}>Log In</Button>
            </div>
            ...
            <div style={{ backgroundColor: '#f4f4f5', padding: 15, borderRadius: 6, borderLeft: '4px solid #71717a' }}>
              <Text style={{ margin: 0, color: '#27272a' }}><strong>Important:</strong> This magic link will expire in 10 minutes.</Text>
            </div>
          </Section>
