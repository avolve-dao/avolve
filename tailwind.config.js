  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'supermind-gradient': 'linear-gradient(to right, #a78bfa, #8b5cf6, #7c3aed, #d946ef, #ec4899)',
        ...
        'superhuman-gradient': 'linear-gradient(to right, #fb7185, #f43f5e, #e11d48, #ef4444, #f97316)',
        'supersociety-gradient': 'linear-gradient(to right, #a3e635, #84cc16, #65a30d, #22c55e, #10b981)',
        'supergenius-gradient': 'linear-gradient(to right, #38bdf8, #0ea5e9, #0284c7, #3b82f6, #6366f1)',
