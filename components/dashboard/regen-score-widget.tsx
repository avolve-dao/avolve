      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>Your regenerative impact level</CardDescription>
          </div>
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs">
                <p>
                  Your Regen Score measures your regenerative impact based on platform activity,
                  community engagement, and token utilization.
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="flex justify-between items-center">
            ...
            <span className="text-sm font-medium">{getScoreLevel(immersionLevel)}</span>
          </div>
