...
export function HumanVerification() {
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setChallengeResponse({ ...challengeResponse, childhood: e.target.value })
                  }
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setChallengeResponse({ ...challengeResponse, favorite: e.target.value })
                  }
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={e =>
                    setChallengeResponse({ ...challengeResponse, reason: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <Button
              ...
              disabled={
                !challengeResponse.childhood ||
                !challengeResponse.favorite ||
                !challengeResponse.reason ||
                submitting
              }
            >
        ...
        return (
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={value =>
                    setChallengeResponse({ ...challengeResponse, purpose: value })
                  }
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="purpose-community">
                      Building a valuable community of extraordinary individuals
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={value =>
                    setChallengeResponse({ ...challengeResponse, privacy: value })
                  }
                >
                  <div className="flex items-center space-x-2">
              ...
              <div className="space-y-2">
                ...
                <RadioGroup
                  ...
                  onValueChange={value =>
                    setChallengeResponse({ ...challengeResponse, contribution: value })
                  }
                >
                  <div className="flex items-center space-x-2">
            ...
            <Button
              onClick={submitChallengeResponse}
              disabled={
                !challengeResponse.purpose ||
                !challengeResponse.privacy ||
                !challengeResponse.contribution ||
                submitting
              }
            >
  ...
  const getTrustLevelName = (level: number) => {
    switch (level) {
      ...
      case 5:
        return 'Pillar of the Community';
      default:
        return `Level ${level}`;
    }
  };
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Complete challenges to verify you're human and build trust
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-lg font-medium">
                {activeChallenge.type_description}
              </CardTitle>
              <CardDescription>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <div className="font-semibold text-lg">
              Trust Score:{' '}
              <span>
                {trustScore?.score !== undefined && trustScore?.score !== null
            ...
            <div className="text-sm text-gray-500">
              Level:{' '}
              <span>
                {trustScore?.level !== undefined && trustScore?.level !== null
                  ? trustScore.level
                  : 'N/A'}
              </span>
            </div>
