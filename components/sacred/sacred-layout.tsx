...
export function SacredLayout({
    ...
    switch (variant) {
      ...
      case 'vesica':
        ...
        return direction === 'horizontal'
          ? {
              display: 'grid',
              gridTemplateColumns: childrenArray.length > 1 ? '36.6% 63.4%' : '1fr',
            }
          : {
              display: 'grid',
              gridTemplateRows: childrenArray.length > 1 ? '36.6% 63.4%' : '1fr',
            };
  ...
  return (
    <div
      className={cn('relative w-full h-full', getBackgroundPattern(), className)}
