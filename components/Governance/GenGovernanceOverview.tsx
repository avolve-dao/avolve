      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">
            The Avolve platform implements a regenerative system centered around the GEN token, with
            daily claims and metrics-driven feature unlocks that encourage regular participation and
        ...
        <TabsContent value="structure" className="space-y-4 mt-4">
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>Ecosystem journey of transformation</CardDescription>
            </CardHeader>
            <CardContent className="pb-2">
              <p className="text-sm text-muted-foreground">
                The GEN token represents the entire ecosystem, encompassing both individual and
                collective journeys. It&apos;s the primary token that drives governance and feature
                unlocks.
              </p>
            </CardContent>
          </Card>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Individual journey of transformation</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <p className="text-sm text-muted-foreground mb-4">
                  The SAP token represents your personal journey, focusing on individual growth and
                  achievement.
                </p>
            ...
            <Card>
              <CardHeader className="pb-2">
                ...
                <CardDescription>Collective journey of transformation</CardDescription>
              </CardHeader>
              <CardContent className="pb-2">
                <p className="text-sm text-muted-foreground mb-4">
                  The SCQ token represents the collective journey, focusing on community growth and
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  Claiming tokens consistently builds your streak multiplier, increasing the rewards
                  you receive:
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-muted-foreground mt-6">
                  ...
                  <ul className="list-disc list-inside mt-2 space-y-1">
                    ...
                    <li>
                      Advanced Features: Unlocked through continued participation and contribution
                    </li>
                  </ul>
                </p>
              </div>
  ...
  return (
    <Card className="overflow-hidden">
      ...
      <CardContent className="pb-4">
        <div className="flex items-center gap-2">
          <div
            className="w-6 h-6 rounded-full bg-gradient-to-r flex items-center justify-center text-white font-bold text-xs"
            style={{
              backgroundImage: `linear-gradient(to right, ${gradient.replace('from-', '').replace('to-', '').replace('via-', '')})`,
            }}
          >
            {icon}
          </div>
...
const MetricImpactCard: React.FC<MetricImpactCardProps> = ({
  metric,
  tokens,
  description,
  icon,
