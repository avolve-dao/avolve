...
1. **Receive an Invitation**: You need a valid invitation code from an existing member to join Avolve
...
| Tier | Validity | Rewards | Description |
|------|----------|---------|-------------|
| Standard | 7 days | Basic welcome bonus | Entry-level invitation |
| Silver | 14 days | 1.5x welcome bonus | Mid-tier invitation with extended validity |
| Gold | 30 days | 2x welcome bonus | Premium invitation with substantial rewards |
| Platinum | 60 days | 3x welcome bonus | Exclusive invitation with maximum benefits |

#### Joining with an Invitation Code

When you receive an invitation to join Avolve, follow these steps to redeem it:

1. **Access the Invitation Link**: Click the invitation link you received or visit [https://avolve.io/join](https://avolve.io/join)
2. **Enter Your Invitation Code**: Input the unique code in the designated field
3. **Verify Code Validity**: The system will verify your code and display the tier information
4. **Create Your Account**: Fill in your details (name, email, password)
5. **Complete Profile Setup**: Add your profile picture and bio
6. **Claim Welcome Bonus**: Once registered, navigate to the "Rewards" section to claim your welcome bonus
7. **Begin Your Journey**: Start with the onboarding challenges to earn your first tokens

**Example**: If you receive a Gold tier invitation, you'll have 30 days to use it before it expires, and upon registration, you'll receive 2x the standard welcome bonus (typically 20 GEN tokens instead of 10).

### Inviting Others

As an Avolve member, you can invite others to join the platform:

1. Navigate to the "Invitations" section in your dashboard
2. Select the invitation tier you wish to create
3. Enter the recipient's email (optional)
4. Click "Create Invitation" to generate a unique code
5. Share the code with your invitee

**Note**: Each tier has a monthly limit on how many invitations you can create. Higher membership levels can create more invitations.
...
The platform follows a weekly schedule for token claims, with each day dedicated to a specific token. Regular participation through daily claims is essential for progressing in your journey and unlocking features.

### Daily Claim Schedule

| Day | Token | Focus Area |
|-----|-------|------------|
...
2. Navigate to the "Daily Claim" section on your dashboard
3. Complete the daily micro-challenge or reflection question
4. Click "Claim [TOKEN]" to receive your tokens
5. Tokens will be immediately added to your wallet

### Claim Streaks and Bonuses

Maintaining a consistent claim streak provides additional benefits:

- **3-Day Streak**: 50% bonus tokens (1.5x reward)
- **6-Day Streak**: 100% bonus tokens (2x reward)
- **9-Day Streak**: 200% bonus tokens (3x reward)

## Contributing with SCQ

The Superachievers (SCQ) pillar represents the collective journey of transformation. Contributing through SCQ tokens allows you to participate in community initiatives and co-create solutions.
...
## Unlocking Features through Metrics
...
A: If you miss a daily challenge, your streak for that token will reset. You'll need to start building your streak again from 1.
...
**Q: Can I complete challenges from previous days?**
A: No, challenges are specific to each day and cannot be completed retroactively. This encourages consistent daily engagement.

**Q: How do I get more invitation codes?**
A: You earn the ability to create invitation codes by being an active member. Higher membership levels and consistent participation increase your monthly invitation allowance.

**Q: What's the difference between daily challenges and token claims?**
A: Daily challenges require completing specific actions to earn tokens, while token claims are simpler daily check-ins. Both contribute to your streaks.

**Q: Can I transfer tokens to other users?**
A: Yes, you can transfer tokens to other users through the "Wallet" section. Different tokens may have different transfer restrictions.

**Q: How do I unlock features faster?**
A: Focus on completing challenges, maintaining consistent daily engagement, and contributing to community initiatives to improve your metrics and unlock features more quickly.
