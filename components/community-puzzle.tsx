    ...
    try {
      ...
      const mockPuzzles: Puzzle[] = [
        ...
        },
        {
          ...
          title: 'Token Pattern',
          description:
            'What comes next in this sequence? SAP, PSP, BSP, SMS, SCQ, SPD, SHE, SSA, ???',
          difficulty: 'medium',
          hints: [
        ...
        },
        {
          ...
          description:
            "I grow stronger when shared, yet I'm never depleted. I connect minds and hearts, through me communities are completed. What am I?",
          difficulty: 'medium',
          hints: [
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <CardDescription>
                <Badge
                  variant="outline"
                  className={`${getDifficultyColor(activePuzzle.difficulty)} border-current`}
                >
                  {activePuzzle.difficulty.charAt(0).toUpperCase() +
                    activePuzzle.difficulty.slice(1)}
                </Badge>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button onClick={submitAnswer} disabled={!userAnswer.trim() || submitting}>
      ...
      <CardContent className="space-y-6">
        <div className="bg-primary/5 p-4 rounded-lg">
          ...
          <p className="text-sm">
            ...
            Each puzzle you solve earns trust points and brings you closer to unlocking special
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="font-medium flex items-center">
                        {puzzle.title}
                        {isCompleted && <Trophy className="h-4 w-4 ml-2 text-amber-500" />}
                      </div>
                      <div className="flex items-center mt-1">
                        <Badge
                          variant="outline"
                          className={`${getDifficultyColor(puzzle.difficulty)} border-current`}
                        >
