  ...
  public: {
    Tables: {
      ...
      journey_posts: {
        ...
        Relationships: [
          {
            foreignKeyName: "journey_posts_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      token_flows: {
        ...
        Relationships: [
          {
            foreignKeyName: "token_flows_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      user_roles: {
        Row: {
          id: string
          user_id: string
          role: 'admin' | 'user' | 'superachiever' | 'superachievers' | 'supercivilization' | 'guest' | 'service_role'
          created_at: string
          updated_at: string
        }
        Insert: {
    ...
    Functions: {
      ...
      has_token_access: {
        Args: { content_token_symbol: string; user_id: string }
        Returns: boolean
      }
      is_admin: {
        Args: Record<PropertyKey, never>
