 ...
 * ```
 */
export function SwipeNavigation({ children, routes, threshold = 100 }: SwipeNavigationProps) {
  ...
  return (
    ...
    >
      {swipeDirection && (
        <div className="swipe-indicator animate-pulse" style={getSwipeIndicatorStyle()} />
      )}
      {children}
    </div>
  );
