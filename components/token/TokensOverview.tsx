    ...
    const fetchTokenData = async () => {
      try {
        ...
        const { data: balanceData, error: balanceError } =
          await supabase.rpc('get_user_token_balances');
        ...
        <TabsContent value="balances" className="space-y-4 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {isLoading ? (
              ...
              // Token balance cards
              tokens.map(token => <TokenBalanceCard key={token.token_symbol} token={token} />)
            ) : (
              // No tokens message
              <Card className="col-span-full">
                <CardHeader>
                  ...
                  <CardDescription>
                    You haven't earned any tokens yet. Complete challenges and contribute to earn
                    tokens.
                  </CardDescription>
                </CardHeader>
              </Card>
