...
export function ChatInput({ chatId, userId, onMessageSent, isGroup = false, chatName = "Chat" }: ChatInputProps) {
  ...
  return (
    <div className={cn("p-4 border-t", isDark ? "bg-zinc-900 border-zinc-800" : "bg-white border-zinc-200")}>
      <div className="flex items-end gap-2">
        <div className="relative flex-1">
          <Textarea
            ...
            className={cn("min-h-[80px] resize-none pr-10", isDark ? "bg-zinc-800 border-zinc-700" : "")}
          />
        ...
        <div className="flex gap-1">
          ...
          <Button onClick={handleSendMessage} disabled={(!message.trim() && !isUploading) || isUploading}>
