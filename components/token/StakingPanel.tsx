...
export function StakingPanel() {
  ...
  const [userProfile, setUserProfile] = useState<{ focus: string; zinc_gradient: number } | null>(
    null
  );
        ...
        {selectedRule && (
          ...
          >
            <h3 className="text-lg font-semibold mb-4">
              Stake {selectedRule.token_type_id.toUpperCase()}
            </h3>
            ...
            <div className="space-y-4">
              ...
              <Button
                onClick={handleStake}
                disabled={
                  isStaking || !amount || parseFloat(amount) < selectedRule.min_stake_amount
                }
                className="w-full"
              >
