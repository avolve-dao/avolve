...
export default function Supermind() {
  ...
  const handleSave = async () => {
    ...
    if (profile) {
      ...
      await supabase.from('supermind_superpowers').insert({
        user_id: userId,
        current_state: fields.current_state,
        desired_state: fields.desired_state,
        action_plan: fields.action_plan,
    ...
    <div className="max-w-xl mx-auto py-10 px-6">
      ...
      {showOnboarding && (
        <div className="mb-6 p-4 bg-violet-100 border-l-4 border-violet-400 text-violet-800 rounded">
          Welcome! Start your journey by entering your supermind states below.{' '}
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-zinc-300">
              Current State{' '}
              <span
                title="Describe your current mindset or situation."
          ...
          <div>
            <label className="block text-zinc-300">
              Desired State{' '}
              <span title="What is your desired outcome or state?" className="ml-1 cursor-help">
                ℹ️
              </span>
            </label>
            <input
          ...
          <div>
            <label className="block text-zinc-300">
              Action Plan{' '}
              <span
                title="What actions will you take to reach your desired state?"
                className="ml-1 cursor-help"
              >
                ℹ️
              </span>
          ...
          <div>
            <label className="block text-zinc-300">
              Results{' '}
              <span title="What results have you achieved so far?" className="ml-1 cursor-help">
                ℹ️
              </span>
            </label>
            <textarea
