                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground">Get suggestions to improve your post</p>
                        </div>
                      </div>
                      <Button type="button" variant="outline" size="sm" onClick={() => setShowGrokEnhancer(true)}>
                        Enhance
                      </Button>
                    </div>
                  </div>
                ...
                {showGrokEnhancer && (
                  <div className="mt-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Button type="button" variant="ghost" size="sm" onClick={() => setShowGrokEnhancer(false)}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                    <GrokPostEnhancer
