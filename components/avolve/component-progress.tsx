...
import {
  getComponentBySlug,
  getUserComponentProgress,
  updateComponentProgress,
} from '@/lib/utils/avolve-db';
...
export function ComponentProgress({ componentSlug, userId }: ComponentProgressProps) {
    ...
    async function loadData() {
      try {
        ...
        try {
          ...
          setValue(
            'currentState',
            progressData.current_state ? JSON.stringify(progressData.current_state) : ''
          );
          setValue(
            'desiredState',
            progressData.desired_state ? JSON.stringify(progressData.desired_state) : ''
          );
          setValue(
            'actionPlan',
            progressData.action_plan ? JSON.stringify(progressData.action_plan) : ''
          );
  ...
  const onSubmit = async (data: ProgressFormValues) => {
    try {
      ...
      try {
        currentState = data.currentState ? JSON.parse(data.currentState) : {};
      } catch (e) {
        currentState = { text: data.currentState };
      }

      try {
        desiredState = data.desiredState ? JSON.parse(data.desiredState) : {};
      } catch (e) {
        desiredState = { text: data.desiredState };
      }

      try {
        actionPlan = data.actionPlan ? JSON.parse(data.actionPlan) : {};
      } catch (e) {
          ...
          <Tabs defaultValue="current" className="w-full">
            ...
            <TabsContent value="current" className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Describe your current situation related to this component.
              </p>
              <Textarea
            ...
            <TabsContent value="desired" className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Describe what you want to achieve with this component.
              </p>
              <Textarea
            ...
            <TabsContent value="plan" className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Outline the steps you'll take to move from current to desired state.
              </p>
              <Textarea
            ...
            <TabsContent value="results" className="space-y-4">
              ...
              <p className="text-sm text-gray-500">
                Document the outcomes and results of your actions.
              </p>
              <Textarea
