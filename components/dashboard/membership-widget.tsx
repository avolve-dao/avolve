        ...
        {loading ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="font-medium">{membership.plan.charAt(0).toUpperCase() + membership.plan.slice(1)} Plan</h3>
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white p-3 rounded-lg">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-white/80">You're one of our first 100 members with free lifetime access!</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="bg-muted/50 p-3 rounded-lg">
              ...
              <div className="flex items-center text-sm">
                ...
                <Badge variant="outline" className="ml-auto">Monthly</Badge>
              </div>
            </div>
            ...
            {!membership.is_free_tier && (
              <div className="flex gap-2">
                ...
                <Button variant="default" className="w-full">Billing History</Button>
              </div>
            )}
          </div>
        ) : (
