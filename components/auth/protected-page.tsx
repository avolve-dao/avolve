        ...
        <Card className="max-w-md w-full">
          ...
          <CardContent className="text-center">
            <div className="text-muted-foreground mb-4">
              <p>This page requires specific permissions or roles that your account doesn't have.</p>
              ...
              {permissions.length > 0 && (
                <div className="mt-2">
                  <p className="font-medium">Required Permission{permissions.length > 1 ? 's' : ''}:</p>
