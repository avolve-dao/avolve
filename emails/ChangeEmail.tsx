      ...
      <Section style={{ backgroundColor: '#f4f4f5', padding: '20px' }}>
        ...
        >
          <Section style={{ backgroundColor: '#18181b', padding: '30px 0', textAlign: 'center' }}>
            {/* Use h1 instead of Text with as prop to avoid TS error */}
          ...
          <Section style={{ padding: '35px 30px', color: '#27272a' }}>
            <Text>Hi there,</Text>
            <Text>
              We received a request to change your email address. To complete this process and
              verify your new email, please click the button below:
            </Text>
            ...
            >
              <Text style={{ margin: 0, color: '#27272a' }}>
                <strong>Security Notice:</strong> If you did not request this change, please ignore
