...
export default function ChangeEmail({ confirmationUrl, email }: ChangeEmailProps) {
  return (
    <Html lang="en">
      <Section style={{ backgroundColor: '#f4f4f5', padding: '20px' }}>
        <Container style={{ maxWidth: 600, margin: '0 auto', backgroundColor: '#fff', borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
          <Section style={{ backgroundColor: '#18181b', padding: '30px 0', textAlign: 'center' }}>
            <Text as="h1" style={{ color: '#fff', margin: 0, fontSize: 24, fontWeight: 600 }}>Confirm Your New Email Address</Text>
          </Section>
          <Section style={{ padding: '35px 30px', color: '#27272a' }}>
            <Text>Hi there,</Text>
            <Text>We received a request to change your email address. To complete this process and verify your new email, please click the button below:</Text>
            <div style={{ textAlign: 'center' }}>
              <Button href={confirmationUrl} style={{ backgroundColor: '#18181b', color: '#fff', padding: '12px 30px', borderRadius: 6, fontWeight: 500, fontSize: 16, margin: '20px 0', textAlign: 'center', border: '1px solid transparent', textDecoration: 'none', display: 'inline-block' }}>Confirm Email Change</Button>
            </div>
            ...
            <div style={{ backgroundColor: '#f4f4f5', padding: 15, borderRadius: 6, borderLeft: '4px solid #71717a' }}>
              <Text style={{ margin: 0, color: '#27272a' }}><strong>Security Notice:</strong> If you did not request this change, please ignore this email or contact support immediately.</Text>
            </div>
          </Section>
