...
export class InvitationRepository implements IInvitationRepository {
    ...
    try {
      ...
      return {
        ...
        error: new InvitationError(
          'An unexpected error occurred while getting invitation tiers',
          error
        ),
      };
    }
   ...
   */
  public async getInvitationTierByName(
    tierName: string
  ): Promise<InvitationResult<InvitationTier>> {
    try {
      const { data, error } = await this.client
        .from('invitation_tiers')
        .select('*')
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting invitation tier',
          error
        ),
      };
    }
  ...
  public async getUserInvitationCountForTier(
    ...
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting user invitation count',
          error
        ),
      };
    }
  ...
  public async getInvitationByCode(code: string): Promise<InvitationResult<Invitation>> {
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting invitation by code',
          error
        ),
      };
    }
  ...
  public async getInvitationById(id: string): Promise<InvitationResult<Invitation>> {
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting invitation by ID',
          error
        ),
      };
    }
  ...
  public async getUserCreatedInvitations(userId: string): Promise<InvitationResult<Invitation[]>> {
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting user created invitations',
          error
        ),
      };
    }
  ...
  public async getUserInvitationsWithInvitees(
    ...
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting user invitations with invitees',
          error
        ),
      };
    }
  ...
  public async getUserReceivedInvitations(
    ...
    try {
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while getting user received invitations',
          error
        ),
      };
    }
  ...
  public async updateInvitationStatus(
    ...
    try {
      const { data, error } = await this.client
        ...
        .update({
          ...
          ...(status === InvitationStatus.CLAIMED
            ? { reward_claimed: true, reward_claimed_at: new Date().toISOString() }
            : {}),
        })
        .eq('id', invitationId)
        .select('*')
      ...
      return {
        data: null,
        error: new InvitationError(
          'An unexpected error occurred while updating invitation status',
          error
        ),
      };
    }
  ...
  private async generateUniqueInvitationCode(length: number = 8): Promise<string> {
    ...
    const { data } = await this.client.from('invitations').select('code').eq('code', result);
