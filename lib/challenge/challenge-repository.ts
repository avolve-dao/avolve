...
export class ChallengeRepository {
    ...
    try {
      ...
      return {
        ...
        error: new ChallengeError(
          'An unexpected error occurred while getting daily challenges',
          error
        ),
      };
    }
  ...
  public async getAllWeeklyChallenges(): Promise<ChallengeResult<WeeklyChallenge[]>> {
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting weekly challenges',
          error
        ),
      };
    }
  ...
  public async getActiveWeeklyChallenges(): Promise<ChallengeResult<WeeklyChallenge[]>> {
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting active weekly challenges',
          error
        ),
      };
    }
   ...
   * @returns A promise resolving to a ChallengeResult containing an array of DailyChallenge objects
   */
  public async getDailyChallengesByDay(
    dayOfWeek: number
  ): Promise<ChallengeResult<DailyChallenge[]>> {
    try {
      const { data, error } = await this.client
        .from('daily_token_challenges')
        .select('*')
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting daily challenges by day',
          error
        ),
      };
    }
  ...
  public async getDailyChallengeById(id: string): Promise<ChallengeResult<DailyChallenge>> {
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting daily challenge',
          error
        ),
      };
    }
  ...
  public async getWeeklyChallengeById(id: string): Promise<ChallengeResult<WeeklyChallenge>> {
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting weekly challenge',
          error
        ),
      };
    }
  ...
  public async getUserChallengeStreaks(
    ...
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting user challenge streaks',
          error
        ),
      };
    }
    ...
    try {
      ...
      if (error) {
        ...
        return {
          data: null,
          error: new ChallengeError(
            `Failed to fetch user challenge streak for token: ${tokenType}`,
            error
          ),
        };
      }
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting user challenge streak by token',
          error
        ),
      };
    }
  ...
  public async hasUserCompletedDailyChallenge(
    ...
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while checking if user completed daily challenge',
          error
        ),
      };
    }
  ...
  public async getUserWeeklyChallengeProgress(
    ...
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while getting user weekly challenge progress',
          error
        ),
      };
    }
    ...
    try {
      ...
      if (checkError) {
        ...
        return {
          data: null,
          error: new ChallengeError(
            'Failed to check existing weekly challenge progress',
            checkError
          ),
        };
      }
  ...
  public async claimChallengeReward(
    ...
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while claiming challenge reward',
          error
        ),
      };
    }
  ...
  public async calculateStreakBonus(
    ...
    try {
      ...
      return {
        data: null,
        error: new ChallengeError(
          'An unexpected error occurred while calculating streak bonus',
          error
        ),
      };
    }
