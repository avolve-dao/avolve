...
export function MemberJourney() {
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-2">
              <div className="flex items-start">
                ...
                <p>
                  Get vouched for by <strong>2 existing members</strong> to unlock more features.
                </p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-amber-100 flex items-center justify-center mr-2 mt-0.5">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-2">
              <div className="flex items-start">
                ...
                <p>
                  Make <strong>3 contributions</strong> to the community to become a Contributor.
                </p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-green-100 flex items-center justify-center mr-2 mt-0.5">
          ...
          <div className="space-y-2">
            ...
            <div className="text-sm space-y-2">
              <div className="flex items-start">
                ...
                <p>
                  Make <strong>7 more contributions</strong> to become a Full Member.
                </p>
              </div>
              <div className="flex items-start">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center mr-2 mt-0.5">
      ...
      case 'full_member':
        return (
          <div className="space-y-2">
            ...
            <p className="text-sm">
              You're a Full Member with complete access to all Avolve features and benefits.
            </p>
            <div className="pt-2">
              <Badge
                variant="outline"
  ...
  const renderAchievements = () => {
    if (!journeyStatus?.achievements || journeyStatus.achievements.length === 0) {
      return (
        <div className="text-center py-2 text-sm text-muted-foreground">No achievements yet</div>
      );
    }

    // Sort achievements by unlock date (newest first)
    const sortedAchievements = [...journeyStatus.achievements].sort(
        ...
        <CardContent>
          <div className="text-center py-6">
            <p className="mb-4 text-muted-foreground">
              You haven't started your member journey yet
            </p>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="h-2 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-amber-500 via-green-500 to-purple-600 rounded-full"
                style={{
                  width: `${
                    journeyStatus.progress?.full_member === 100
                      ? 100
                      : journeyStatus.progress?.contributor === 100
                        ? 75
                        : journeyStatus.progress?.vouched === 100
                          ? 50
                          : 25
                  }%`,
                }}
