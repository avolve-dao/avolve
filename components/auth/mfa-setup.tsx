...
export function MfaSetup() {
  ...
  const handleRevokeSession = async (sessionId: string) => {
    if (
      !confirm(
        'Are you sure you want to sign out this device? The user will need to sign in again.'
      )
    ) {
      return;
    }
  ...
  const handleRevokeAllOtherSessions = async () => {
    if (
      !confirm(
        'Are you sure you want to sign out all other devices? Users will need to sign in again.'
      )
    ) {
      return;
    }
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
      <TabsList className="grid w-full grid-cols-3">
        <TabsTrigger value="setup">{hasMfa ? 'Manage 2FA' : 'Setup 2FA'}</TabsTrigger>
            ...
            {hasMfa ? (
              <div className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    Two-factor authentication is enabled for your account. You'll need to enter a
              ...
              <div className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    Two-factor authentication adds an extra layer of security to your account. Even
                    if someone knows your password, they won't be able to sign in without access to
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Each code can only be used once. Keep these codes in a safe place, like a password
                manager. If you lose access to your authenticator app and don't have these codes,
          ...
          <CardFooter className="flex justify-between">
            ...
            <Button onClick={() => setActiveTab('setup')}>Continue</Button>
          </CardFooter>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="sessions">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Manage your active sessions across different devices. You can sign out from any device
                  ...
                  <TableBody>
                    {sessions.map(session => (
                      <TableRow key={session.id}>
                        <TableCell className="font-medium">{formatDeviceInfo(session)}</TableCell>
