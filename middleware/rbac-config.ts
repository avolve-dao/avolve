...
export const routeProtection: RouteProtectionConfig = {
  ...
  '/reset-password': { requiredRoles: [], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  '/update-password': { requiredRoles: [], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  ...
  '/dashboard': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  ...
  '/teams/[id]': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  '/teams/create': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  '/teams/discover': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  '/tokens': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },

  // Super features
  '/super/puzzles': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/super/puzzles/[id]': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/super/puzzles/[id]/contribute': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/super/puzzles/today': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/super/sacred-geometry': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/super/participation': { requiredRoles: ['super'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },

  // Admin routes
  '/admin': { requiredRoles: ['admin'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/admin/analytics': { requiredRoles: ['admin'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/admin/users': { requiredRoles: ['admin'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/admin/content': { requiredRoles: ['admin'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  '/admin/security': { requiredRoles: ['admin'], requiredPermissions: [], unauthorizedRedirect: '/unauthorized' },
  ...
  '/protected': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
  '/subscription': { requiredRoles: ['user'], requiredPermissions: [], unauthorizedRedirect: '/signin' },
